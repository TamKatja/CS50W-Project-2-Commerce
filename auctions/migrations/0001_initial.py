    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_price', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(0.05, message='Invalid starting price')])),
                ...
                ('watchlist', models.ManyToManyField(blank=True, null=True, related_name='user_watching', to=settings.AUTH_USER_MODEL)),
            ],
            options={
